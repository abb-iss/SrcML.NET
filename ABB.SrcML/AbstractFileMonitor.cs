...
namespace ABB.SrcML {
    ...
    public abstract class AbstractFileMonitor : IDisposable {
        ...
        // in this method, the monitoredFiles is actually the list of files whose srcML files should be added
        public void BatchAddition(Collection<string> fileList) {
            SrcMLFileLogger.DefaultLogger.Info(">>>>>>> AbstractFileMonitor.BatchAddition()");
        ...
        // in this method, the monitoredFiles is actually the list of files whose srcML files should be deleted
        public void BatchDeletion(Collection<string> fileList) {
            SrcMLFileLogger.DefaultLogger.Info(">>>>>>> AbstractFileMonitor.BatchDeletion()");
