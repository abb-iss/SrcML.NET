...
namespace ABB.SrcML
{
    ...
    public class Src2SrcMLRunner : SrcMLRunner
    {
        ...
        public Src2SrcMLRunner(string applicationDirectory)
            : this(applicationDirectory, new Collection<string>() { LIT.ArgumentLabel, OP.ArgumentLabel, TYPE.ArgumentLabel, POS.ArgumentLabel })
        {
        ...
        public Src2SrcMLRunner(string applicationDirectory, Collection<string> namespaceArguments)
