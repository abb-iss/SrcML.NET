...
namespace ABB.SrcML.Data {
    ...
    /// It takes a SrcML XElement as input to the Visit method and then generates an IEnumerable of <see cref="Scope"/> objects.
    ...
    public class SrcMLElementVisitor {
        ...
        /// <summary>
        /// <para>Visit constructs a scope element a Scope and then recursively visits all of the children of the element.</para>
        /// 
        /// <para>It relies on <see cref="Parser"/> to determine construct the Scope and determine what the children of the element are.</para>
        /// </summary>
        /// <param name="element">The element to visit</param>
        /// <returns>All of the Scope objects rooted at this element.</returns>
        public Scope Visit(XElement element) {
        ...
        private Scope CreateScope(XElement element) {
            Scope scope = Parser.CreateScope(element, FileUnit);
        ...
        public static Scope Visit(XElement element, AbstractCodeParser parser) {
