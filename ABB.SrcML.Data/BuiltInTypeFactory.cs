...
namespace ABB.SrcML.Data {
    /// <summary>
    /// The Built-In type factory creates on-demand instances of built-in types for each language. It creates and stores one <see cref="TypeDefinition"/> object for
    /// each <see cref="ABB.SrcML.Language"/>/built-in type pair. This factory is primarily used by when comparing <see cref="TypeUse"/> objects for method parameters.
    /// A parameter and an argument should have the same <see cref="TypeDefinition"/> object.
    /// </summary>
