...
namespace ABB.SrcML.Data {
    /// <summary>
    /// <para>NameHelper provides a collection of static methods that aid in parsing elements of with a node type of <see cref="ABB.SrcML.SRC.Name"/>.</para>
    /// <para>The functions are targetted at helping to parse the common srcML idiom of nesting <see cref="ABB.SrcML.SRC.Name"/> elements within other <see cref="ABB.SrcML.SRC.Name">name elements.</see></para>
    /// </summary>
    public static class NameHelper {
        ...
        public static IEnumerable<XElement> GetNameElementsFromName(XElement nameElement) {
            ...
            if(nameElement.Name != SRC.Name) throw new ArgumentException("should be a SRC.Name", "nameElement");
        ...
        /// <summary>
        /// Gets the string value for the <see cref="GetLastNameElement(XElement)">last name element</see> of <paramref name="nameElement"/>
        /// </summary>
        /// <param name="nameElement">The name element</param>
        ...
        /// <summary>
        /// Gets the last name from <paramref name="nameElement"/>. If <paramref name="nameElement"/> has no children of type <see cref="ABB.SrcML.SRC.Name"/>, it just returns <paramref name="nameElement"/>.
        /// </summary>
        /// <param name="nameElement">The name element</param>
        /// <returns>The last <see cref="ABB.SrcML.SRC.Name">name element</see> in <paramref name="nameElement"/>. If there are none, it returns <paramref name="nameElement"/></returns>
        ...
        /// <summary>
        /// Gets the string values for all of the name elements in <paramref name="nameElement"/> <see cref="GetNameElementsExceptLast(XElement)">except for the last one</see>.
        /// </summary>
        /// <param name="nameElement">The name element</param>
        ...
        /// <summary>
        /// Gets all of the name elements from <paramref name="nameElement"/>. If <paramref name="nameElement"/> has no children of type <see cref="ABB.SrcML.SRC.Name"/>, returns an empty enumerable.
        /// </summary>
        /// <param name="nameElement">The name element</param>
        /// <returns>An enumerable of <see cref="ABB.SrcML.SRC.Name">name elements</see> in <paramref name="nameElement"/> except for the <see cref="GetLastNameElement">last one</see></returns>
