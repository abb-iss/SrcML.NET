...
namespace ABB.SrcML.Data.Test {
	...
	<decl_stmt><decl><type><name>A</name></type> <name>a</name></decl>;</decl_stmt>
            ...
            var globalScope = CodeParser[Language.Java].ParseFileUnit(fileUnitA) as NamespaceDefinition;
            globalScope = globalScope.Merge(CodeParser[Language.Java].ParseFileUnit(fileUnitB) as NamespaceDefinition);
            globalScope = globalScope.Merge(CodeParser[Language.Java].ParseFileUnit(fileUnitC) as NamespaceDefinition);
...
<function><type><name>int</name></type> <name>main</name><parameter_list>()</parameter_list> <block>{ <expr_stmt><expr><name>a</name><op:operator>.</op:operator><call><name>Foo</name><argument_list>()</argument_list></call></expr>;</expr_stmt> <return>return <expr><lit:literal type=""number"">0</lit:literal></expr>;</return> }</block></function>";
            ...
            var globalAObject = globalScope.FindExpressions<VariableDeclaration>(true).FirstOrDefault();
            ...
            Assert.AreEqual(typeA, globalAObject.VariableType.FindMatches().FirstOrDefault());

            var mainFunction = globalScope.GetNamedChildren<MethodDefinition>("main").FirstOrDefault();

            Assert.IsNotNull(mainFunction, "could not find main function");

            var callToADotFoo = mainFunction.FindExpressions<MethodCall>(true).FirstOrDefault();
...
<function><type><name>int</name></type> <name>main</name><parameter_list>()</parameter_list> <block>{
    ...
    <return>return <expr><lit:literal type=""number"">0</lit:literal></expr>;</return>
            ...
            var header = CodeParser[Language.CPlusPlus].ParseFileUnit(headerElement) as NamespaceDefinition;
            var implementation = CodeParser[Language.CPlusPlus].ParseFileUnit(implementationElement) as NamespaceDefinition;
            var main = CodeParser[Language.CPlusPlus].ParseFileUnit(mainElement) as NamespaceDefinition;
...
<class>class <name>B</name> <block>{<private type=""default""> <function><type><name>void</name></type> <name>Foo</name><parameter_list>()</parameter_list> <block>{ }</block></function> </private>}</block>;</class>";
	...
	<function><type><name>void</name></type> <name>main</name><parameter_list>()</parameter_list> <block>{
		<expr_stmt><expr><call><name><name>b</name><op:operator>.</op:operator><name>Foo</name></name><argument_list>()</argument_list></call></expr>;</expr_stmt>
            ...
            NamespaceDefinition globalScope = CodeParser[Language.CSharp].ParseFileUnit(aUnit);
            ...
            Assert.AreEqual(typeB, callingObject.ResolveType());
        ...
        public void TestMethodCallToParentType_CSharp() {
            ...
            var aDotFoo = typeA.GetNamedChildren<MethodDefinition>("Foo").FirstOrDefault();
            var bDotBar = typeB.GetNamedChildren<MethodDefinition>("Bar").FirstOrDefault();

            Assert.IsNotNull(aDotFoo, "could not find method A.Foo()");
            Assert.IsNotNull(bDotBar, "could not find method B.Bar()");

            var callToFooFromB = bDotBar.FindExpressions<MethodCall>(true).FirstOrDefault();
...
<namespace>namespace <name>D</name> <block>{
    <class>class <name>E</name> <block>{<private type=""default"">
        <function><type><name>void</name></type> <name>main</name><parameter_list>()</parameter_list> <block>{
            ...
            NamespaceDefinition globalScope = CodeParser[Language.CPlusPlus].ParseFileUnit(cUnit);
            ...
            Assert.AreSame(typeC, cDeclaration.VariableType.ResolveType());
...
<namespace>namespace <name>D</name> <block>{
    <class>class <name>E</name> <block>{
        <function><type><name>void</name></type> <name>main</name><parameter_list>()</parameter_list> <block>{
            ...
            NamespaceDefinition globalScope = CodeParser[Language.CSharp].ParseFileUnit(cUnit);
...
<class>class <name>E</name> <block>{
    <function><type><specifier>public</specifier> <specifier>static</specifier> <name>void</name></type> <name>main</name><parameter_list>()</parameter_list> <block>{
        ...
        <expr_stmt><expr><call><name><name>c</name><op:operator>.</op:operator><name>Foo</name></name><argument_list>()</argument_list></call></expr>;</expr_stmt>
            ...
            NamespaceDefinition globalScope = CodeParser[Language.Java].ParseFileUnit(cUnit);
...
//            NamespaceDefinition globalScope = CodeParser[Language.CPlusPlus].ParseFileUnit(aUnit);
